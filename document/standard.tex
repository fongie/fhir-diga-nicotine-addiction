...
standards for interoperability within healthcare. The Standard should be as flexible as possible to allow for different applications to fit it to their needs, but also define a sufficiently specific format for exporting patient data. The specific use-cases that the Standard is targetting are:
